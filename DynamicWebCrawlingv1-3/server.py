...
async def run_python():
    # 여기서 request.json() 같은 것을 사용할 필요가 없다면 제거해도 됩니다.
    # HTML에서 body에 JSON을 보냈지만, 현재 Flask 예시에서는 사용하지 않았습니다.
    # 만약 body의 number 값을 사용하고 싶다면 아래와 같이 정의할 수 있습니다:
    # @app.post("/run-python")
    ...
    try:
        # test1/crawling.py 스크립트 실행
        # Flask 예시와 동일하게 subprocess를 사용합니다.
